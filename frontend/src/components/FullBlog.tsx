...
function FullBlog({ blog }: { blog: Blog }) {
    ...
    return (
        <div className='absolute w-full'>
            <AppBar />
            <div className='absolute border-[1px]  w-fit border-zinc-300 shadow ml-10 mt-1 hover:shadow-xl hover:bg-zinc-800 hover:text-zinc-300 hover:border-none duration-150 rounded-full text-3xl font-semibold' onClick={()=>navigate(-1)}><IoIosArrowRoundBack /></div>
            <div className="grid grid-cols-2 grid-rows-1 gap-4 p-6 bg-gray-50 rounded-lg overflow-hidden">
                ...
                <div className="col-span-1 shadow-xl absolute w-[50%] top-15  right-0 h-full overflow-y-auto">
                    ...
                    <div>
                        <div className="text-xl font-semibold mb-2 px-4">Recent Posts by {blog.author.name || "Anonymous"}:</div>
